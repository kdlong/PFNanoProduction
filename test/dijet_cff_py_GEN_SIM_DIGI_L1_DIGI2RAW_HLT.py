...
# with command line options: Configuration/PFNano/python/dijet_cff.py --conditions auto:phase1_2021_realistic -n 12 --era Run3 --eventcontent FEVTDEBUGHLT -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --datatier GEN-SIM --geometry DB:Extended --pileup NoPileUp --no_exec --fileout step2_phase1_new.root --nThreads 12
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/PFNano/python/dijet_cff.py nevts:12'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_phase1_new.root'),
