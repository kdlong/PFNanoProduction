...
# with command line options: Configuration/PFNano/python/dijet_cff.py --conditions auto:phase1_2021_realistic -n 12 --era Run3 --eventcontent FEVTDEBUGHLT -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --datatier GEN-SIM --geometry DB:Extended --pileup NoPileUp --no_exec --fileout step2_phase1_new.root --nThreads 12 --customise Validation/RecoParticleFlow/customize_pfanalysis.customize_step2 --python_filename=step2_phase1_new.py
...
from Validation.RecoParticleFlow.customize_pfanalysis import customize_step2 

#call to customisation function customize_step2 imported from Validation.RecoParticleFlow.customize_pfanalysis
process = customize_step2(process)
