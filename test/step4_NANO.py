...
# with command line options: step4 --conditions auto:phase1_2021_realistic --datatier NANOAOD --era Run3 --eventcontent NANOAODGEN --data --nThreads 12 --filein file:step3_phase1_new.root --fileout pfNano_phase1_new.root --step NANO
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step3_phase1_new.root'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('pfNano_phase1_new.root'),
